...
?>
 ...
 <?php foreach ($photographer_data as $value) { ?>
                <div class="col-md-3 team-grids wow bounceIn animated photo<?php echo $value['city_id'] ?>" data-wow-delay=".5s" style="visibility: visible; -webkit-animation-delay: .5s;">
                    ...
                    <a href="profile.php?id=<?php echo $value['id'] ?>">
                        <img class="img-responsive" src="images/<?php echo $value['image'] ?>" alt="" style="height: 340px;"/>
                        <div class="captn">
